...
import com.itpm.timetablemanagement.form.lecturer.AddLecturer;
...
import com.ITPM.timetablemanagement.allocateroom.allocateRoom;
import com.ITPM.timetablemanagement.form.timetable.TimtableMenu;
...
import com.ITPM.timetablemanagement.form.working_hours.EditWorkingDayHours;

//import com.spm.timetablemanagement.form.working_hours.InsertWorkingHours;
import com.ITPM.timetablemanagement.location.InsertBuilding; 
...
import com.ITPM.timetablemanagement.form.subject.AddSubject;
import com.ITPM.timetablemanagement.form.subject.ViewSubject;
...
import com.ITPM.timetablemanagement.statistics.stats;
...
//        MenuItem menuView = new MenuItem(iconSubmenu, "View Details", null);
    ...
    private void initComponents() {
        ...
        panelHeader.setBackground(new java.awt.Color(17, 95, 224));
        ...
        menus.setBackground(java.awt.Color.gray);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Msi\\OneDrive\\Desktop\\ITPM_Final\\Timetable-Manager\\src\\com\\ITPM\\timetablemanagement\\resource\\abclogosss.png")); // NOI18N
